...
const modules = ['game-data', 'unit-models', 'patriot-model', 'imported-gun-effects', 'abrams-model', 'anti-tank-model', 'machine-gun-model', 'artillery-model', 'fighter-model', 'missile-flight', 'battlefield-3d', 'battle-audio'];
