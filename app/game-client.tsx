...
const AIRCRAFT_ART: Record<SortieKind, { src: string; drawSize: number }> = {
  interceptor: { src: "./assets/fighter/fighter-portrait.png", drawSize: 56 },
  multirole: { src: "./assets/fighter/fighter-portrait.png", drawSize: 56 },
  strike: { src: "./assets/fighter/fighter-portrait.png", drawSize: 58 },
    ...
    <main className="battle-shell">
      ...
      <Dialog open={manualOpen} onOpenChange={setManualOpen}>
        <DialogContent className="game-dialog manual-dialog">
          ...
          <p className="text-xs text-muted-foreground"><a href="./assets/machine-gun/credits.html" target="_blank" rel="noreferrer" className="underline">Machine gun model credit and license</a> · <a href="./assets/artillery/credits.html" target="_blank" rel="noreferrer" className="underline">Artillery model credit and license</a> · <a href="./assets/fighter/credits.html" target="_blank" rel="noreferrer" className="underline">Fighter model credit and license</a> · <a href="./assets/soldier/credits.html" target="_blank" rel="noreferrer" className="underline">Enemy soldier model credit and license</a> · <a href="./assets/truck/credits.html" target="_blank" rel="noreferrer" className="underline">Enemy truck model credit and license</a></p>
        </DialogContent>
      </Dialog>
